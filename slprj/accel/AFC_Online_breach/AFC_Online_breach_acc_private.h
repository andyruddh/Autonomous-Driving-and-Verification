...
#ifndef RTW_HEADER_AFC_Online_breach_acc_private_h_
#define RTW_HEADER_AFC_Online_breach_acc_private_h_
#include "rtwtypes.h"
...
; real_T AFC_Online_breach_acc_rt_VTDelayfindtDInterpolate ( real_T x ,
